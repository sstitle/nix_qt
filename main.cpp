...
int main(int argc, char *argv[]) {
  ...
  desc.add_options()("help", "produce help message")(
      "lang", boost::program_options::value<std::string>()->default_value("en"),
  ...
  QObject::connect(&buttonEn, &QPushButton::clicked,
                   [&]() { updateGreeting("en"); });
  QObject::connect(&buttonEs, &QPushButton::clicked,
                   [&]() { updateGreeting("es"); });
  QObject::connect(&buttonFr, &QPushButton::clicked,
                   [&]() { updateGreeting("fr"); });
